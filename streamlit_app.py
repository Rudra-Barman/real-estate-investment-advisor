...
st.markdown('<h3 class="sub-header">ML-powered Property Investment Analysis & Future Price Prediction</h3>', unsafe_allow_html=True)

# Load models, artifacts, and data
@st.cache_resource
def load_artifacts():
    try:
        ...
        return reg_model, clf_model, scaler, label_encoders, feature_columns, df
...
if page == "🏠 Property Analysis":
    ...
    with st.sidebar.form("property_form"):
        ...
        with col2:
            ...
            current_price = st.number_input("Current Price (₹ Lakhs)", min_value=10.0, max_value=500.0, value=250.0, step=10.0)
    ...
    if submit_button:
        with st.spinner("Analyzing property..."):
            ...
            try:
                ...
                # Row 1: Price Projection & Feature Importance
                col1, col2 = st.columns(2)
                ...
                # Row 2: Investment Factors & Market Comparison
                col1, col2 = st.columns(2)
        ...
        # Show welcome message when no analysis
        st.markdown("""
